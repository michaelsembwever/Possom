...
public final class HittaWeatherSearchCommand extends AbstractWebServiceSearchCommand {

    private static final Logger LOG = Logger.getLogger(HittaWeatherSearchCommand.class);

    private static final String ERR_FAILED_HITTAMAP_SEARCH = "Failed Weather search command";

    private static final String ERR_FAILED_ENCODE_HITTAWEATHER = "Failed to encode Weather search query";
    ...
    public ResultList<? extends ResultItem> execute() {
    	...
    	HittaWeatherCommandConfig bsc = (HittaWeatherCommandConfig) context.getSearchConfiguration();
