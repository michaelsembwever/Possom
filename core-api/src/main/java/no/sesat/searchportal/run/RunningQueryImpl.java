...
import no.sesat.searchportal.datamodel.DataModelFactory;
...
import no.sesat.searchportal.query.analyser.AnalysisRule;
...
import no.sesat.searchportal.mode.SearchCommandFactory;
import no.sesat.searchportal.mode.config.SearchConfiguration;
import no.sesat.searchportal.mode.SearchMode;
import no.sesat.searchportal.mode.executor.SearchCommandExecutorFactory;
...
import no.sesat.searchportal.result.Enrichment;
...
import no.sesat.searchportal.run.handler.NavigationRunningQueryHandler;
import no.sesat.searchportal.run.handler.RunningQueryHandler;
...
public class RunningQueryImpl extends AbstractRunningQuery implements RunningQuery {
   ...
   // Constants -----------------------------------------------------
    ...
    private static final Logger ANALYSIS_LOG = Logger.getLogger("no.sesat.searchportal.analyzer.Analysis");
