...
public class FastCommandConfigBeanInfo extends CommandConfigBeanInfo {
    ...
    public FastCommandConfigBeanInfo() throws ClassNotFoundException, IntrospectionException {
        this(FastCommandConfig.class);
    }

    public FastCommandConfigBeanInfo(Class<?> cls) throws ClassNotFoundException, IntrospectionException {
        super(cls);
