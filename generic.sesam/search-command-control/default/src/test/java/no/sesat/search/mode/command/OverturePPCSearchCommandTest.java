 ...
 * @version $Id$
 */
public class OverturePPCSearchCommandTest extends AbstractSearchCommandTest {
    ...
    public void testNot()  throws Exception{
        executeTestOfQuery("test1 -test2", "test1", "");
    }

    @Test
    public void testLeadingNot()  throws Exception{
        executeTestOfQuery("-test1 test2", "test2", "");
    }
    ...
    public void testLeadingNotAndOr()  throws Exception{
        executeTestOfQuery("-a (test1 test2)", "test1 OR test2", "");
    }

    @Test
    public void testLotsOfNots()  throws Exception{
        executeTestOfQuery("-a d -b -e c -f", "d      c", "");
        executeTestOfQuery("-a d -b -e c g -f", "d      c  g", "");
        executeTestOfQuery("-a -b c", "c", "");
        executeTestOfQuery("-a (e f) c", "e OR f  c", "");
    }
    ...
    private AbstractYahooSearchCommand executeTestOfQuery(
        ...
        final SearchCommand.Context cxt = createCommandContext(query, fakeTab, "default-overture-ppc-command");
        final AbstractYahooSearchCommand cmd = new OverturePPCSearchCommand(cxt);
