 ...
 * @version $Id$
 */
public class YahooIdpSearchCommandTest extends AbstractSearchCommandTest {
    ...
    private AbstractYahooSearchCommand executeTestOfQuery(
        ...
        final SearchCommand.Context cxt = createCommandContext(query, fakeTab, "default-yahoo-command");
        final AbstractYahooSearchCommand cmd = new YahooIdpSearchCommand(cxt);
