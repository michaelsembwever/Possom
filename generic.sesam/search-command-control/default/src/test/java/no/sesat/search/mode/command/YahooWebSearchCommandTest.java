 ...
 * @version $Id$
 */
public class YahooWebSearchCommandTest extends AbstractSearchCommandTest {
    ...
    private YahooWebSearchCommand executeTestOfQuery(
        ...
        final SearchCommand.Context cxt = createCommandContext(query, fakeTab, "default-yahoo-web-command");
        final YahooWebSearchCommand cmd = new YahooWebSearchCommand(cxt);
