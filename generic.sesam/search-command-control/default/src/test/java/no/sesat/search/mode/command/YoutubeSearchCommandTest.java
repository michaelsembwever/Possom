 ...
 * @version $Id$
 */
public class YoutubeSearchCommandTest extends AbstractSearchCommandTest {
    ...
    private YoutubeSearchCommand executeTestOfQuery(
        ...
        final SearchCommand.Context cxt = createCommandContext(query, fakeTab, "default-youtube-command");
        final YoutubeSearchCommand cmd = new YoutubeSearchCommand(cxt);
