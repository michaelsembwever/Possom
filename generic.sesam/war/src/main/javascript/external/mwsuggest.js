...
/** OTHER MEDIAWIKI JAVASCRIPT REQUIRED BY MWSUGGEST **/
...
/** end-of OTHER MEDIAWIKI JAVASCRIPT... **/


/* declarations required in a vertical specific location. sesam.com puts this directly into its head.jsp
 * 
...
function os_delayedFetch(){
	...
	os_timer = null;
	var path = wgMWSuggestTemplate.replace("{searchTerms}",os_encodeQuery(query));
