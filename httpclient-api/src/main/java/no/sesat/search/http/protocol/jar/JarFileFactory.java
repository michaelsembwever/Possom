...
class JarFileFactory implements URLJarFile.URLJarFileCloseController {
    ...
    JarFile get(URL url, boolean useCaches, JarURLConnection parentConnection) throws IOException {
        ...
        if (useCaches) {
            ...
            if (result == null) {
                local_result = URLJarFile.getJarFile(url, this, parentConnection);
                synchronized (this) {
                    result = getCachedJarFile(url);
                    if (result == null) {
