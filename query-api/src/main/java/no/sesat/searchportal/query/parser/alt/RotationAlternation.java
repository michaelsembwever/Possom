...
package no.sesat.searchportal.query.parser.alt;
...
import no.sesat.searchportal.query.XorClause.Hint;
import no.sesat.searchportal.query.finder.Counter;
import no.sesat.searchportal.query.finder.ForestFinder;
 ...
 * <ul>
 * <li> Query {@link no.sesat.searchportal.query.analyser Analysis} relies on all possible term combinations to
 ...
 * </li>
 * <li> The {@link no.sesat.searchportal.query.finder.ParentFinder ParentFinder} class, a utility visitor
 ...
 * <li> {@link no.sesat.searchportal.query.transform.SynonymQueryTransformer SynonymQueryTransformer}.
 ...
 *          tokenPredicate.
 * </li>
 * <li> {@link no.sesat.searchportal.query.finder.WhoWhereSplitter WhoWhereSplitter} is a utility vistor that 
