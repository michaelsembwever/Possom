 ...
 *
 */
package no.sesat.searchportal.mode.config;

import java.io.Serializable;
import no.sesat.searchportal.query.transform.QueryTransformerConfig;
import no.sesat.searchportal.result.handler.ResultHandlerConfig;
...
public interface SearchConfiguration extends Serializable {
    /**
     * Returns a (defensive copy) list of {@link no.sesat.searchportal.query.transform.QueryTransformer} that should be applied to
    ...
    /**
     * Adds a {@link no.sesat.searchportal.query.transform.QueryTransformer} to the list of transformeres.
     *
    ...
    /**
     * Returns a list of {@link no.sesat.searchportal.result.handler.ResultHandler} that should act on the search
     * result.
     *
    ...
    /**
     * Adds a {@link no.sesat.searchportal.result.handler.ResultHandler} to the list of handlers.
     *
     ...
     * {@link no.sesat.searchportal.mode.config.SearchMode}
     *
