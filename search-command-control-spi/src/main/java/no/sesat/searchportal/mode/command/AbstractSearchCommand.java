...
import no.sesat.searchportal.query.parser.TokenMgrError;
...
import no.sesat.searchportal.query.transform.QueryTransformer;
import no.sesat.searchportal.query.transform.QueryTransformerConfig;
import no.sesat.searchportal.query.transform.QueryTransformerFactory;
...
import no.sesat.searchportal.result.handler.DataModelResultHandler;
import no.sesat.searchportal.result.handler.ResultHandler;
import no.sesat.searchportal.result.handler.ResultHandlerConfig;
import no.sesat.searchportal.result.handler.ResultHandlerFactory;
...
public abstract class AbstractSearchCommand extends AbstractReflectionVisitor implements SearchCommand, Serializable {
    ...
    protected static final Logger DUMP = Logger.getLogger("no.sesat.searchportal.Dump");
...
//        }
    ...
    private final class FilterVisitor extends AbstractReflectionVisitor {
        ...
        private void appendFilter(String term, final String field) {
            ...
            try{
                fastCommandConfig = Class.forName("no.sesat.searchportal.mode.config.FastCommandConfig")
