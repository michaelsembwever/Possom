...
package no.sesat.searchportal.mode.executor;

import java.lang.reflect.Constructor;
import java.lang.reflect.InvocationTargetException;
import no.sesat.searchportal.mode.SearchMode;
import no.sesat.searchportal.mode.SearchMode.SearchCommandExecutorConfig.Controller;
...
public final class SearchCommandExecutorFactory {
    ...
    public static SearchCommandExecutor getController(final SearchMode.SearchCommandExecutorConfig config){
        ...
        try{
            ...
            final String name = "no.sesat.searchportal.mode.executor."
