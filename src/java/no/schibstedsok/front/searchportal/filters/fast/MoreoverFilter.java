 ...
 */
public class MoreoverFilter extends AsynchronusBaseFilter{
    ...
    public void doExecuteAsynch(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        filterConfig.getServletContext().log("- Fast Moreover - Searching");
        ...
        configuration.setCollection(SearchConstants.MOREOVER_COLLECTION);
        configuration.setTemplate(VelocityTemplates.MOREOVER_COLLECTION_SEARCH);
