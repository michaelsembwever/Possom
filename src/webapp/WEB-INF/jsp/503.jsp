...
<body style="margin:0; padding:0;">
    ...
    <div style="padding-left:30px; font-size:12px; font-family: arial, sans-serif;">
        <p>
            Det har desverre oppstått en feil.<br />
            Vi setter pris p&#229; om du kan sende oss en tilbakemelding om feilen: <a href="mailto:webmaster@schibstedsok.no">webmaster@schibstedsok.no</a>
        </p>
        <p>
