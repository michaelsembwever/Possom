           ...
           <decorator:getProperty property="page.blogDateNavigation"/>
            ...
            <c:if test='${!(empty tab.rssResultName)}'>
                <div  style="margin-top: 11px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="navbar_table">
                        <tr>
                            <td class="nav_pad"><a href="<c:out value='${request.requestURL}' escapeXml="false" style="display:inline;" />?<c:out value='${request.queryString}' escapeXml="false"/>&output=rss">RSS</a>&nbsp;&nbsp; |&nbsp;&nbsp; <a href="<c:out value='${request.requestURL}' escapeXml="false" style="display:inline;"/>?<c:out value='${request.queryString}' escapeXml="false"/>&output=rss&feedType=atom_0.3">ATOM</a></td>
                        </tr>
                        <tr>
