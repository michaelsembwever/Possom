...
import no.schibstedsok.searchportal.view.navigation.NavigationConfig.Nav.ControllerFactory;
 ...
 * @version $Id$
 */
@ControllerFactory("no.schibstedsok.searchportal.view.navigation.tab.TabNavigationControllerFactory")
