...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
    ...
    <ShortName><search:text key="navbarMain_${DataModel.parameters.values['c'].utf8UrlEncoded}"/></ShortName> 
    ...
    <Url type="text/html" template="http://<c:out value='${DataModel.site.site.name}'/>search/?q={searchTerms}&amp;c=<c:out value='${DataModel.parameters.values["c"].utf8UrlEncoded}'/>&amp;IGNORE=NOCOUNT"/> 
